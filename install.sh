...
set_permissions() {
  ...
  ui_print "[3/5] Installing man and less executables.."
  chown 0:0 $MODPATH/system/bin/*;
  chmod -R 755 $MODPATH/system/bin/*;

  ui_print "[4/5] Installing terminfo.."
  ...
  #find $MODPATH/system/usr/tmp -type f -exec chmod 644 {} +;
